<template>
    <div>
        ...
        <validation-messages v-if="checkMessage" v-bind:messages="getMessage" ></validation-messages>
        ...
        <div class="login-page">
            ...
            <form  class="form">
                ...
                <my-button type="submit" @click.prevent="SendForgotPassword">Send password </my-button>
